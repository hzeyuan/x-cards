...
const DynamicStyleTippyComponent = ({ children, content, tippyOptions = {} }) => {
...
const PlasmoInline: React.FC<PlasmoCSUIProps> = ({ anchor }) => {
    ...
    return (
        ...
        <DynamicStyleTippyComponent content={menuContent} root={anchor.element.querySelector('#plasmo-shadow-container')}>
